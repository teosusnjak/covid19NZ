...
# Latest COVID-19 Data updates (23-04-2020) : Current Trends and Forecasts
...
![COVID19_length_of_outbreaks](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Stage+of+the+COVID-19+Outbreak++Across+Selected+Countries+23-04-2020.jpg)
...
![COVID19_global_spread](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Daily+Percentage+Changes+in+Reported+COVID-19+Cases+in+Selected+Countries+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Daily+Percentage+Changes+in+Reported+COVID-19+Cases+in+Selected+Countries+and+NZ+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Mean+Daily+Percentage+Changes+in+Reported+COVID-19+Cases+across+Selected+Countries+and+NZ+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+New+Confirmed+COVID-19+Cases+in+NZ+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+Total+Confirmed+COVID-19+Cases+in+NZ+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Hospitalisations+and+ICU+Requirements+Due+to+COVID-19+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Percentage+Change+in+Reported+COVID-19+Cases+Comparing+NZ+and+Singapore+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+New+Confirmed+COVID-19+Cases+in+NZ+-+scenario+2+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+Total+Confirmed+COVID-19+Cases+in+NZ+-+scenario+2+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Hospitalisations+and+ICU+Requirements+Due+to+COVID-19+-+scenario+2+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+New+Confirmed+COVID-19+Cases+in+NZ+-+scenario+3+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+Total+Confirmed+COVID-19+Cases+in+NZ+-+scenario+3+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Hospitalisations+and+ICU+Requirements+Due+to+COVID-19+-+scenario+3+23-04-2020.jpg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/Current+and+Predicted+Deaths+Due+to+COVID19+in+NZ+-+scenario+3+23-04-2020.jpg)
...
In New Zealand there is robust debate about when lockdown should end. Some say it needs to end now. On RNZ National on 20 April, University of Auckland Professor Shaun Hendy advocated for an extension of at least two weeks. Shaun Hendy leads a team that has been modelling COVID-19 data. That analysis has been considered by Government Ministers over the weekend.

His area is complex systems and networks, and his team will have modelled both the consequences of lockdown extension, and lockdown easing. Here I look at a simple lockdown extension scenario. The rate of daily infections was modelled over time. Recoveries were modelled from infections. Both models were used to predict what might happen in the next two weeks if we were to stay locked down.
...
If ‘elimination’* is the Government’s goal, then a further two weeks of lockdown seems promising.
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZLookingAhead.jpeg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZCounterFactual.jpeg)

![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZCounterFactual_b.jpeg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZInfectionOrigin.jpeg)

![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZInfectionOrigin_b.jpeg)

### Infections by District Health Board

The Southern District Health Board has seen a disproportionate number of infections. This is perhaps partly due to the effect of clusters of infection, combined with a relatively low infection rate overall in NZ. Had NZ not introduced border controls and lockdown, and had the virus been given more opportunity to circulate, we would likely see are more even distribution of clusters, community transmission, and more equal infection rates across regions. It is also likely relevant that the Southern DHB encompasses some of NZ’s more popular tourism spots.

![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZInfectionDHB_a.jpeg)
...
![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZInfectionDHB_b.jpeg)

![COVID19](https://gdp-live.s3-ap-southeast-2.amazonaws.com/covid19/20200423_CovidNZInfectionDHB_c.jpeg)
